...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('planning.store') }}" id="planningForm">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <label for="planned_date" class="form-label">Plant <span class="text-danger">*</span></label>
    ...
    $(document).ready(function() {
        ...
        $('#department_id').on('change', function() {
            ...
            if (deptId && approvalLevelsByDept[deptId]) {
                const levels = approvalLevelsByDept[deptId][plantId];
                ...
                if (levels.length === 0) {
                    ...
                    levels.forEach((level, index) => {
                        $approvalSelect.append(`<option value="${level.job_level_id}">${level.level_name} - ${level.approver_name}</option>`);
                    });
