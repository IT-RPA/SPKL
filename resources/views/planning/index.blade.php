...
@section('content')
    ...
    <div class="page-header">
        ...
        @php
            $userLevelCode = auth()->user()->jobLevel ? auth()->user()->jobLevel->code : null;
        @endphp
        @if(in_array(auth()->user()->level_jabatan, ['Department Head', 'Administrator']) || $userLevelCode === 'FORE')
                    ...
                    <tbody>
                        @forelse($plannings as $planning)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('planning.show', $planning->id) }}" class="btn btn-sm btn-outline-primary"
                                        title="Lihat Detail">
