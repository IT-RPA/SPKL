...
@section('content')
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Hide less important columns on mobile ONLY for main table */
            #approvalsTable th:nth-child(3),
            #approvalsTable td:nth-child(3),
            #approvalsTable th:nth-child(4),
            #approvalsTable td:nth-child(4),
        ...
        @media (max-width: 480px) {
            ...
            #approvalsTable th:nth-child(5),
            #approvalsTable td:nth-child(5),
            #approvalsTable th:nth-child(8),
            #approvalsTable td:nth-child(8) {
                display: none;
            }
                    ...
                    <tbody>
                        @forelse($approvals as $approval)
                            <tr>
                                ...
                                <td>{{ $approval->overtimeRequest->requesterEmployee->name ?? $approval->overtimeRequest->requester->name }}
                                </td>
                                <td class="d-none d-md-table-cell">
                                    {{ $approval->overtimeRequest->requesterEmployee->jobLevel->name ?? $approval->overtimeRequest->requester_level }}
                                </td>
                                ...
                                <td>
                                    ...
                                    @if($approval->status == 'pending')
                                        ...
                                        @if($canApproveNow)
                                            <br><small class="text-success"><i class="fas fa-clock"></i> <strong>Giliran
                                                    Anda</strong></small>
                                        @elseif($isCurrentUserApprover && $previousPendingExists)
                                            <br><small class="text-warning"><i class="fas fa-hourglass-half"></i> Menunggu Approval
                                                Sebelumnya</small>
                                        @endif
                                    @elseif(isset($approval->needs_percentage_input) && $approval->needs_percentage_input)
                                        <br><small class="text-warning"><i class="fas fa-percentage"></i> <strong>Perlu Input
                                                Persentase</strong></small>
                                    @endif
                                </td>
                            </tr>
                        @empty
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="rejectForm">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label for="reason" class="form-label">Alasan Penolakan <span
                ...
                <div class="modal-body">
                    ...
                    <form id="rejectDetailForm">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="detailRejectionReason" rows="4" required minlength="10"
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus pengajuan lembur dengan nomor: <strong
                            id="deleteRequestNumber"></strong>?</p>
                    <p class="text-danger"><i class="fas fa-exclamation-triangle"></i> Tindakan ini tidak dapat dibatalkan!
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
            ...
            function generateDetailContent(data) {
                ...
                if (canInputPercentage && hasQualitativeDetails && hasPercentageInputReady) {
                    ...
                    if (qualitativeDetails.length > 0) {
                        ...
                        <form id="editPercentageForm" class="mb-3">
                            <div class="table-responsive">
                            ...
                            <button type="button" class="btn btn-success btn-sm w-100" onclick="updatePercentage()">
