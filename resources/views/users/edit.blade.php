        ...
        <div class="card-body">
            <form method="POST" action="{{ route('users.update', $user) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-select select2-role @error('role_id') is-invalid @enderror" id="role_id"
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                name="phone" value="{{ old('phone', $user->phone) }}" placeholder="628xxxx">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Awal 62, hanya angka</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control bg-light" id="name" value="{{ $employee->name }}"
                                readonly>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control bg-light" id="email" value="{{ $employee->email }}"
                                readonly>
                            <small class="text-muted">Otomatis dari data employee</small>
                        </div>
                    </div>
                ...
                <div class="alert alert-info mt-3">
                    ...
                    data user akan <strong>otomatis diupdate</strong> mengikuti perubahan tersebut. Namun Role tetap sesuai
                    pilihan manual Anda.
                </div>
